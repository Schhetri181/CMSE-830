...
with pca_tab:
    ...
    x = st.selectbox("Select Category for PCA", ["fixed acidity", "volatile acidity", "citric acid", "alcohol"])
    y = st.selectbox("Select Category for PCA", ["residual sugar", "chlorides", "free sulfur dioxide", "sulphates"])
    z = st.selectbox("Select Category for PCA", ["total sulfur dioxide", "density", "pH"])
...
with model_tab:
    ...
    with col1:
        ...
        i4 = st.slider("Residual Sugar", min_value=0.0, max_value=15.5, format="%.2f")
        i7 = st.slider("Total Sulfur Dioxide", min_value=0, max_value=289)
    ...
    with col2:
        ...
        i8 = st.slider("Density", min_value=0.0, max_value=1.0, format="%.4f")
    ...
    with col3:
        ...
        i9 = st.slider("pH", min_value=0.0, max_value=14.0, format="%.2f")
...
with class_tab:
    ...
    with col1:
        ...
        i7 = st.slider("Total Sulfur Dioxide", min_value=0, max_value=289, key="i7")
